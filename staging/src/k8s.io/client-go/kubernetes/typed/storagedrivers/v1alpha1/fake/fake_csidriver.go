...
type FakeCSIDrivers struct {
	Fake *FakeStoragedriversV1alpha1
}

var csidriversResource = schema.GroupVersionResource{Group: "drivers.storage.k8s.io", Version: "v1alpha1", Resource: "csidrivers"}

var csidriversKind = schema.GroupVersionKind{Group: "drivers.storage.k8s.io", Version: "v1alpha1", Kind: "CSIDriver"}
