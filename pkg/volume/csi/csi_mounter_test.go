...
func TestMounterSetUp(t *testing.T) {
	...
	pubs := csiMounter.csiClient.(*csiDriverClient).nodeClient.(*fake.FakeNodeClient).GetNodePublishedVolumes()
...
func TestUnmounterTeardown(t *testing.T) {
	...
	pubs := csiUnmounter.csiClient.(*csiDriverClient).nodeClient.(*fake.FakeNodeClient).GetNodePublishedVolumes()
